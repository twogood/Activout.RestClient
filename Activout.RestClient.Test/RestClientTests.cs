...
namespace Activout.RestClientTest
{
    public class RestClientTests
    {
        ...
        public async Task TestGetEmptyIEnumerableAsync()
        {
            ...
            IMovieReviewService reviewSvc = CreateMovieReviewService();
        ...
        public async Task TestErrorAsync()
        {
            ...
            // act
            var aggregateException = await Assert.ThrowsAsync<AggregateException>(() => reviewSvc.GetAllReviews(movieId));
